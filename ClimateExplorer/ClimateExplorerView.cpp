...
/////////////////////////////////////////////////////////////////////////////
IMPLEMENT_DYNCREATE(CClimateExplorerView, CBaseView)

/////////////////////////////////////////////////////////////////////////////
BEGIN_MESSAGE_MAP(CClimateExplorerView, CBaseView)
	// Standard printing commands
	ON_COMMAND(ID_FILE_PRINT, &CBaseView::OnFilePrint)
	ON_COMMAND(ID_FILE_PRINT_DIRECT, &CBaseView::OnFilePrint)
	ON_COMMAND(ID_FILE_PRINT_PREVIEW, &CClimateExplorerView::OnFilePrintPreview)
	ON_WM_CONTEXTMENU()
	ON_WM_RBUTTONUP()
	ON_COMMAND(ID_SCROLL_TOP, &CClimateExplorerView::OnScrollTop)
	ON_COMMAND(ID_SCROLL_BOTTOM, &CClimateExplorerView::OnScrollBottom)
	ON_COMMAND(ID_SCROLL_PAGEUP, &CClimateExplorerView::OnScrollPageup)
	ON_COMMAND(ID_SCROLL_PAGEDOWN, &CClimateExplorerView::OnScrollPagedown)
	ON_COMMAND(ID_SCROLL_LINEUP, &CClimateExplorerView::OnScrollLineup)
	ON_COMMAND(ID_SCROLL_LINEDOWN, &CClimateExplorerView::OnScrollLinedown)
	ON_COMMAND(ID_FILE_EXPORTPAGES, &CClimateExplorerView::OnFileExportPages)
...
/////////////////////////////////////////////////////////////////////////////
CClimateExplorerView::~CClimateExplorerView()
{
}
...
/////////////////////////////////////////////////////////////////////////////
BOOL CClimateExplorerView::PreCreateWindow(CREATESTRUCT& cs)
{
...
/////////////////////////////////////////////////////////////////////////////
void CClimateExplorerView::RenderMargins
(
...
/////////////////////////////////////////////////////////////////////////////
void CClimateExplorerView::RenderHeader
(
	CDC* pDC, double dLeftOfView, double dTopOfView,
	double dRightOfView, double dBottomOfView
)
...
/////////////////////////////////////////////////////////////////////////////
void CClimateExplorerView::RenderFooter
(
	CDC* pDC, double dLeftOfView, double dTopOfView,
	double dRightOfView, double dBottomOfView
)
...
/////////////////////////////////////////////////////////////////////////////
void CClimateExplorerView::RenderTitlePage
(
	CDC* pDC, double dLeftOfView, double dTopOfView,
	double dRightOfView, double dBottomOfView
)
...
/////////////////////////////////////////////////////////////////////////////
void CClimateExplorerView::RenderTableOfContentsPage
(
	CDC* pDC, double dLeftOfView, double dTopOfView,
	double dRightOfView, double dBottomOfView
)
...
/////////////////////////////////////////////////////////////////////////////
void CClimateExplorerView::RenderImagePage
(
	CDC* pDC, double dLeftOfView, double dTopOfView,
	double dRightOfView, double dBottomOfView
)
...
//
// This is the core of ClimateExplorer’s multi‑page rendering engine.
/////////////////////////////////////////////////////////////////////////////
void CClimateExplorerView::render
(
	CDC* pDC,
	double dLeftOfView,
	double dTopOfView,
...
/////////////////////////////////////////////////////////////////////////////
void CClimateExplorerView::ExportDocument()
{
	CClimateExplorerDoc* pDoc = GetDocument();
	...
	for (auto& node : keyPages.Items)
	{
		...
		if (bExportPDF)
		{
			...
			CHelper::EncodeBitmapToMemory
			(
				&bitmap, L"image/jpeg", jpegBuffer, ulQuality
			);
...
/////////////////////////////////////////////////////////////////////////////
void CClimateExplorerView::OnDraw(CDC* pDC)
{
	CClimateExplorerDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
	if (!pDoc)
...
/////////////////////////////////////////////////////////////////////////////
void CClimateExplorerView::OnInitialUpdate()
{
...
/////////////////////////////////////////////////////////////////////////////
void CClimateExplorerView::OnContextMenu(CWnd* pWnd, CPoint point)
{
...
/////////////////////////////////////////////////////////////////////////////
void CClimateExplorerView::AssertValid() const
{
	CBaseView::AssertValid();
}

/////////////////////////////////////////////////////////////////////////////
void CClimateExplorerView::Dump(CDumpContext& dc) const
{
	CBaseView::Dump(dc);
}
...
void CClimateExplorerView::OnScrollTop()
{
...
/////////////////////////////////////////////////////////////////////////////
void CClimateExplorerView::OnScrollBottom()
{
	CScrollBar* pVert = GetScrollBarCtrl(SB_VERT);
...
/////////////////////////////////////////////////////////////////////////////
void CClimateExplorerView::OnScrollPageup()
{
	CScrollBar* pVert = GetScrollBarCtrl(SB_VERT);
...
/////////////////////////////////////////////////////////////////////////////
void CClimateExplorerView::OnScrollPagedown()
{
	CScrollBar* pVert = GetScrollBarCtrl(SB_VERT);
...
/////////////////////////////////////////////////////////////////////////////
void CClimateExplorerView::OnScrollLineup()
{
	CScrollBar* pVert = GetScrollBarCtrl(SB_VERT);
...
/////////////////////////////////////////////////////////////////////////////
void CClimateExplorerView::OnScrollLinedown()
{
	CScrollBar* pVert = GetScrollBarCtrl(SB_VERT);
...
/////////////////////////////////////////////////////////////////////////////
void CClimateExplorerView::OnFileExportPages()
{
	PDF = false;
	ExportDocument();
...
/////////////////////////////////////////////////////////////////////////////
void CClimateExplorerView::OnUpdateFileExportPages(CCmdUI* pCmdUI)
{
	CClimateExplorerDoc* pDoc = GetDocument();
...
/////////////////////////////////////////////////////////////////////////////
void CClimateExplorerView::OnFilePdf()
{
	PDF = true;
	ExportDocument();
...
/////////////////////////////////////////////////////////////////////////////
void CClimateExplorerView::OnUpdateFilePdf(CCmdUI* pCmdUI)
{
